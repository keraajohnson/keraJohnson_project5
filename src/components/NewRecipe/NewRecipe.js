        ...
        return(
            <section className="newRecipeSection">
                <div className="newButton clearfix">
                    <button onClick={this.handleClick} className='newRecipeButton'>New <i className="fas fa-plus"></i></button>
                </div>
                    ...
                    <form onSubmit={this.handleSubmit}>
                        <div className="recipeInput">
                            ...
                            <div className="ingredientContainer container">
                                ...
                                <button className="ingredientButton recipeButton" onClick={this.addNewIngredient}><i className="fas fa-plus"></i></button>
                            </div>
                            ...
                            <div className="directionsContainer container">
                                ...
                                <button className="directionsButton recipeButton" onClick={this.addNewDirection}><i className="fas fa-plus"></i></button>
                            </div>
